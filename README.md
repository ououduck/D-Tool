...
| 分类 | 工具 |
| --- | --- |
| 编码加密 (12) | URL 编码/解码、Base64、Base32、HTML 实体、Unicode、ASCII、JWT 解析、Gzip、MD5、SHA 哈希、摩斯电码、凯撒密码 |
| 转换计算 (14) | 时间戳、进制、单位换算、CSV/JSON、颜色、日期计算、时区转换、倒计时、计算器、百分比、BMI、房贷、人民币大写、罗马数字 |
| 图片处理 (9) | 图片压缩、图片转 Base64、图片裁剪、旋转翻转、格式转换、滤镜、文字水印、九宫格切图、图片取色 |
| 文本格式 (9) | JSON、XML、Markdown 编辑器、正则测试、文本对比、文本处理、命名转换、文字转语音、假文生成 |
| 生成工具 (8) | 二维码、EAN-13 条形码、UUID、随机数、随机抽奖、密码生成、CSS 渐变、CSS 阴影 |
| 网络信息 (13) | IP 查询、UA 解析、URL 解析、HTTP 状态码、MIME 类型、常用端口、正则速查、对比度检查、Luhn 银行卡校验、身份证校验、浏览器信息、HTML/CSS 压缩、在线便签 |
